                ...
                <div class="product-imgs-wrapper">
                    <div class="product-thumbnails">
                        <a href='#' class="product-thumbnail-item">
                            <img src="{{ asset('images/product2_thumbnail_trans.png') }}" alt="">
                        </a>
                        <a href='#' class="product-thumbnail-item">
                            <img src="{{ asset('images/product2_thumbnail_trans.png') }}" alt="">
                        </a>
                    ...
                    <div class="main-product-img-wrapper">
                        <img src="{{ asset('images/main_product2.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="product-details mt-lg-0 mt-4">
                    <h5>AS - Mrożone Mięso - Dieta BARF</h5>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="d-flex gap-3 align-items-center flex-wrap">
                            <a href="#" class="btn btn-primary-outline px-4">wołowe</a>
                            <a href="#" class="btn btn-gray-outline px-4">wołowo-drobiowe</a>
                        </div>
                    </div>
