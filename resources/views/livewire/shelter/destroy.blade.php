<div class="title text-left mb-4 d-md-block">
    ...
    <a onclick="$('#deleteModal').modal('toggle')" class="text-decoration-none"><img src="{{ asset('images/close_icon.svg') }}"> <small class="ms-1 text-muted">Usuń schronisko</small></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="cart-items">
                        ...
                        <div class="cart-item desktop d-flex align-items-center justify-content-between">
                            <div class="product-details d-flex align-items-center">
                                Czy napewno chcesz usunąć schronisko {{$shelter->name}} (ID: {{$shelter->id}})?
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <a wire:click="deleteShelter" href="#" type="button" class="btn btn-secondary">Usuń</a>
                </div>
            </div>
        </div>
    </div>
