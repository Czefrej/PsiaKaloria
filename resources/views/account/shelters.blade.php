            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="title text-left mb-4 d-md-block d-none">
                        <a href="{{route('account.create-shelter')}}" class="text-decoration-none"><img src="{{ asset('images/plus_icon.svg') }}"> <small class="ms-1 text-muted">Dodaj nowe schronisko</small></a>
                        <span class="title-leading text-primary mb-2 d-block">&nbsp;</span>
                        <h2 class="mt-3">Lista schronisk</h2>
                    </div>
                    <table id="shelters-table" class="display">
                        <thead>
                        <tr>
                            <th>Nazwa</th>
                            <th>Adres</th>
