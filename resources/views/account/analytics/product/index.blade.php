        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="title text-left mb-4 d-md-block">
                    <a href="{{route('account.analytics.product.create')}}" class="text-decoration-none"><img src="{{ asset('images/plus_icon.svg') }}"> <small class="ms-1 text-muted">Dodaj nowy produkt</small></a>
                    <span class="title-leading text-primary mb-2 d-block">&nbsp;</span>
                    <h2 class="mt-3">Lista produktów</h2>
                </div>
                <div class="editable-wrapper">
                    ...
                    @endif
                    <table id="products-table" class="table table-striped display">
                        <thead>
                        <tr>
                            <th>SKU</th>
                            <th>COGS</th>
                            <th>Koszt pakowania</th>
