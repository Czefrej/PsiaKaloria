            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="title text-left mb-4 d-md-block d-none">
                        ...
                        <a href="#" class="text-decoration-none"><img src="{{ asset('images/back_arrow_icon.svg') }}"> <small class="ms-1 text-muted">Wróć do ustawień</small></a>
                    ...
                    <div class="editable-wrapper">
                        <form>
                            ...
                            <div class="btn-wrapper d-flex gap-4">
                                <a href="#" class="btn btn-primary-light w-50">Anuluj</a>
